              ...
              {menuItems.map((item, index) => (
                ...
                >
                  <a
                    ...
                    className={`hover:-translate-y-1 flex items-center justify-center h-full py-2 px-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-pink-500 text-[17px] transition-colors duration-300 ${
