  ...
  return (
    <div className="relative h-20 overflow-hidden w-full z-0 my-12">
      <div className="absolute inset-0 flex items-center justify-center">
        {title && (
          <h2 className="text-4xl font-bold bg-[#1A1A1D] px-4 py-2 rounded-md relative z-10">
...
const TeamSection: React.FC<TeamSectionProps> = ({ title, members, size = 'md', id }) => {
  ...
  return (
    ...
    >
      {title && (
        ...
        >
          <motion.h2
            className="text-5xl font-bold text-center relative z-10 bg-gradient-to-r from-violet-400 via-fuchsia-500 to-pink-500 text-transparent bg-clip-text"
          >
            {title}
          </motion.h2>
          <motion.div
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className="text-gray-400 md:text-[18px] text-[14px]">{member.role}</p>
              </motion.div>
            </motion.div>
          </motion.div>
        ))}
...
const TeamPage: React.FC = () => {
  ...
  const teams: Teams = {
    overallCoordinators: [
      { name: "Uday Sunkaraboina", role: "Overall Coordinator", imageUrl: './Uday.webp' },
      { name: "Kesava Mahitha", role: "Overall Coordinator", imageUrl: './Mahitha.webp' }
    ],
    eventHeads: [
      { name: "Koushik", role: "Event Head", imageUrl: './012A89345 - Gunnam Sri Satya Koushik.webp' },
      { name: "Manoj Kumar", role: "Event Head", imageUrl: './WhatsApp Image 2024-12-03 at 8.39.18 PM - Ponnamanda Manoj Kumar.webp' },
      { name: "Venkata Dheeraj", role: "Event Head", imageUrl: './Screenshot_2024_1202_154212 - Kurapati Venkata Dheeraj.webp' }
    ],
    eventCoordinators: [
    ...
    hospitalityCoordinators: [
      ...
      { name: "Jagdeesh ", role: "Hospitality Coordinator", imageUrl: './1707648307618 - Kodadala Jagadeesh(1).webp' },
    ...
    multimediaHeads: [
      ...
      { name: "Venu", role: "Multimedia Head", imageUrl: './IMG_1091 - Banavath Venu Naik.webp' }
    ],
    multimediaCoordinators: [
      { name: "Subhasis Basa", role: "Multimedia Coordinator", imageUrl: './IMG_20241116_133913347_MF_PORTRAIT (1) - Subhasis Basa.webp' },
      { name: "Silky Sau ", role: "Multimedia Coordinator", imageUrl: './Silky sau.webp' },
      { name: "Shresth Kumar ", role: "Multimedia Coordinator", imageUrl: './IMG20220528123259 - Shresth Kumar.webp' },
      { name: "Raja Mohan", role: "Multimedia Coordinator", imageUrl: './IMG_20230714_181417x - P N V RAJA MOHAN.webp' },
      { name: "Viraj Rajpure", role: "Multimedia Coordinator", imageUrl: './4320DEAA-D521-4483-9185-1D283E6641D3 - Rajpure Viraj Mohan.webp' },
      { name: "Eslavath Jayanth", role: "Multimedia Coordinator", imageUrl: './IMG_6870 - Eslavath Jayanth(1).webp' },
      { name: "Abhinaba Das", role: "Multimedia Coordinator", imageUrl: './1000103049 - Abhinaba Das.webp' },
      { name: "Jayanth Ram", role: "Multimedia Coordinator", imageUrl: './IMG_3729 - Ramavath Jayanth Ram(1).webp' }
    ],
    prHeads: [
      { name: "Nikita", role: "PR Head", imageUrl: './Nikita Tuwani ( Publicity Head) - Nikita Tuwani.webp' },
      { name: "Balusu Bhanu Prakash", role: "PR Head", imageUrl: './FullSizeRender(5) - Balusu Bhanu Prakash.webp' }
    ],
    prCoordinators: [
      { name: "Bharath", role: "PR Coordinator", imageUrl: './Pic - Mamidi Bharath.webp' },
      { name: "Abhi Rohan", role: "PR Coordinator", imageUrl: './IMG-20230626-WA0000 - Kunkumagunta Sachidananda Sake Abhirohan.webp' },
      { name: "Vivek ", role: "PR Coordinator", imageUrl: './Vivek.webp' },
      { name: "Athiradh", role: "PR Coordinator", imageUrl: './athiradh 1 1 - Athiradh R N(1).webp' },
      { name: "Dharani", role: "PR Coordinator", imageUrl: './Dharani.webp' },
      { name: "Gayatri Priya", role: "PR Coordinator", imageUrl: './Gayatri.webp' }
    ],
    webHeads: [
    ...
    webCoordinators: [
      ...
      { name: "Praneeth", role: "Web Coordinator", imageUrl: './Praneeth.webp' },
      { name: "Rudranil Basak", role: "Web Coordinator", imageUrl: './20240830_130542 - Rudranil Basak.webp' },
      { name: "Dhiraj Baid", role: "Web Coordinator", imageUrl: './Dhiraj_baid.webp' },
    ]
  };

  return (
    <div className="min-h-screen bg-[#1A1A1D] px-4 py-12 relative overflow-hidden">
