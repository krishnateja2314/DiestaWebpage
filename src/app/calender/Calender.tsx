  ...
  return (
    <>
                ...
                .map((event, key) => (
                  ...
                  >
                    ...
                    <h3 className="text-sm">
                      Participants: {event.TeamA}{" "}
                      <span className="text-[#C084FC] text-lg font-semibold">
                        {" "}
                        vs{" "}
                      </span>{" "}
                      {event.TeamB}
      ...
      <div className="flex justify-center mt-8">
        <Calendar
          className={
            "rounded-3xl border border-gray-200  bg-white text-gray-800 font-semibold" +
            " hover:ring-2 hover:ring-purple-300 transition-all duration-300"
          }
